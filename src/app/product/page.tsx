    ...
    <>
      <section className="px-12 md:px-24 pt-36 pb-12 relative bg-white">
        <div className="space-y-2">
          ...
          <h2 className="max-w-md w-full text-gray-700">Berikut daftar produk yang kami jual untuk memebuhi kebutuhan makanan Anda yang lezat, bergizi, dan praktis.</h2>
        </div>
