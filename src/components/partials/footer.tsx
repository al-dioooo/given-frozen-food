...
export default function Footer() {
  ...
  return (
    <footer className="bg-radial-[at_50%_100%] from-orange-100 via-gray-100 via-60% to-gray-100 px-12 md:px-24 pt-16 pb-36 relative overflow-hidden">
      ...
      <div className="absolute pointer-events-none inset-0 w-full flex justify-center items-end translate-y-3 md:translate-y-18 whitespace-nowrap">
        <p className="text-5xl md:text-[8rem] font-black text-gray-50">Given Frozen Food</p>
      </div>
    </footer>
  )
}
