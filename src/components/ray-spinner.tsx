...
import Ray from "@/components/graphics/ray"

export default function RaySpinner({ className, baseVelocity = 100 }: { className?: string, baseVelocity?: number }) {
  ...
  return (
    <motion.span className="w-full h-full" style={{ rotate }}>
      <Ray className={className} />
    </motion.span>
  )
}
